...
class TrainerRNN(object):
    ...
    def train(self, start_epoch, end_epoch, batch_size, output_f, start_time=None):
        ...
        for epoch in range(start_epoch, end_epoch + 1):
            ...
            loss, recall, mrr = self.evaluation.evalRNN(self.train_data, batch_size)
            ...
            loss, recall, mrr = self.evaluation.evalRNN(self.eval_data, batch_size)
