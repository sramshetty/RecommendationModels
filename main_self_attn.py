...
parser.add_argument('--valid_data', default='valid_item.pickle', type=str)
...
def main():
    ...
    valid_data = dataset.DatasetAttn(valid_data, data_name, observed_threshold, window_size, itemmap=train_data.items)
